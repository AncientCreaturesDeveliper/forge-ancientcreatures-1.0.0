...
public class JPScaffoldingBlock extends Block implements IWaterLoggable 
{	
	...
	public JPScaffoldingBlock(AbstractBlock.Properties properties) 
	{
		super(properties);
	...
	public static int getDistance(IBlockReader blockReader, BlockPos pos) 
	{
		...
		int i = 7;
		if (blockstate.isIn(BlockInit.JURASSIC_PARK_ERA_METAL_SCAFFOLDING.get())) 
		{
		...
		for(Direction direction : Direction.Plane.HORIZONTAL) 
		{
			...
			if (blockstate1.isIn(BlockInit.JURASSIC_PARK_ERA_METAL_SCAFFOLDING.get())) 
			{
	...
	static 
	{
		...
		FULL_SHAPE = VoxelShapes.or(JPScaffoldingBlock.BOTTOM_SLAB_SHAPE, TOP_SLAB_SHAPE, voxelshape6, voxelshape5, voxelshape8, voxelshape7);
	}
}
