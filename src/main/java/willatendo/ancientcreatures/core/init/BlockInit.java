...
public class BlockInit 
{
	...
	public static final RegistryObject<WallBlock> JURASSIC_WORLD_ERA_POLISHED_CONCRETE_WALL = ModRegistry.BLOCK_TYPES.register("jurassic_world_era_polished_concrete_wall", () -> new WallBlock(AbstractBlock.Properties.create(Material.ROCK).harvestTool(ToolType.PICKAXE).harvestLevel(2).setRequiresTool().hardnessAndResistance(6.0F, 12.0F).sound(SoundType.STONE)));
	public static final RegistryObject<StoneButtonBlock> JURASSIC_WORLD_ERA_POLISHED_CONCRETE_BUTTON = ModRegistry.BLOCK_TYPES.register("jurassic_world_era_polished_concrete_button", () -> new StoneButtonBlock(AbstractBlock.Properties.create(Material.ROCK).harvestTool(ToolType.PICKAXE).harvestLevel(2).setRequiresTool().hardnessAndResistance(6.0F, 12.0F).sound(SoundType.STONE).doesNotBlockMovement()));
	public static final RegistryObject<PressurePlateBlock> JURASSIC_WORLD_ERA_POLISHED_CONCRETE_PRESSURE_PLATE = ModRegistry.BLOCK_TYPES.register("jurassic_world_era_polished_concrete_pressure_plate", () -> new PressurePlateBlock(Sensitivity.MOBS, AbstractBlock.Properties.create(Material.ROCK).harvestTool(ToolType.PICKAXE).harvestLevel(2).setRequiresTool().hardnessAndResistance(6.0F, 12.0F).sound(SoundType.STONE).doesNotBlockMovement()));
