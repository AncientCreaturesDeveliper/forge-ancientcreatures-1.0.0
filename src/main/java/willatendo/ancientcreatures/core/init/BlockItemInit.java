...
public class BlockItemInit 
{
	...
	public static final RegistryObject<BlockItem> JURASSIC_WORLD_ERA_INNOVATION_CENTRE = ModRegistry.ITEM_TYPES.register("jurassic_world_era_innovation_centre_door", () -> new BlockItem(BlockInit.JURASSIC_PARK_ERA_TOILET_DOOR.get(), new Item.Properties().group(CreativeTab.ANCIENT_TAB)));
	public static final RegistryObject<BlockItem> JURASSIC_WORLD_ERA_GLASS_DOOR = ModRegistry.ITEM_TYPES.register("jurassic_world_era_glass_door", () -> new BlockItem(BlockInit.JURASSIC_PARK_ERA_VISITOR_CENTRE_DOOR.get(), new Item.Properties().group(CreativeTab.ANCIENT_TAB)));
	public static final RegistryObject<BlockItem> JURASSIC_WORLD_ERA_BACK_DOOR = ModRegistry.ITEM_TYPES.register("jurassic_park_era_back_door", () -> new BlockItem(BlockInit.JURASSIC_PARK_ERA_SECURITY_DOOR.get(), new Item.Properties().group(CreativeTab.ANCIENT_TAB)));
