...
public class BlockItemInit 
{
	...
	public static final RegistryObject<BlockItem> JURASSIC_PARK_ERA_POLISHED_CONCRETE = ModRegistry.ITEM_TYPES.register("jurassic_park_era_polished_concrete", () -> new BlockItem(BlockInit.JURASSIC_PARK_ERA_POLISHED_CONCRETE.get(), new Item.Properties().group(CreativeTab.ANCIENT_TAB))); 
	public static final RegistryObject<BlockItem> JURASSIC_PARK_ERA_POLISHED_CONCRETE_SLAB = ModRegistry.ITEM_TYPES.register("jurassic_park_era_polished_concrete_slab", () -> new BlockItem(BlockInit.JURASSIC_PARK_ERA_POLISHED_CONCRETE_SLAB.get(), new Item.Properties().group(CreativeTab.ANCIENT_TAB))); 
	public static final RegistryObject<BlockItem> JURASSIC_PARK_ERA_POLISHED_CONCRETE_STAIRS = ModRegistry.ITEM_TYPES.register("jurassic_park_era_polished_concrete_stairs", () -> new BlockItem(BlockInit.JURASSIC_PARK_ERA_POLISHED_CONCRETE_STAIRS.get(), new Item.Properties().group(CreativeTab.ANCIENT_TAB))); 
	public static final RegistryObject<BlockItem> JURASSIC_PARK_ERA_POLISHED_CONCRETE_WALL = ModRegistry.ITEM_TYPES.register("jurassic_park_era_polished_concrete_wall", () -> new BlockItem(BlockInit.JURASSIC_PARK_ERA_POLISHED_CONCRETE_WALL.get(), new Item.Properties().group(CreativeTab.ANCIENT_TAB))); 
	public static final RegistryObject<BlockItem> JURASSIC_PARK_ERA_POLISHED_CONCRETE_BUTTON = ModRegistry.ITEM_TYPES.register("jurassic_park_era_polished_concrete_button", () -> new BlockItem(BlockInit.JURASSIC_PARK_ERA_POLISHED_CONCRETE_BUTTON.get(), new Item.Properties().group(CreativeTab.ANCIENT_TAB))); 
	public static final RegistryObject<BlockItem> JURASSIC_PARK_ERA_POLISHED_CONCRETE_PRESSURE_PLATE = ModRegistry.ITEM_TYPES.register("jurassic_park_era_polished_concrete_pressure_plate", () -> new BlockItem(BlockInit.JURASSIC_WORLD_ERA_POLISHED_CONCRETE_PRESSURE_PLATE.get(), new Item.Properties().group(CreativeTab.ANCIENT_TAB))); 
	...
	public static final RegistryObject<BlockItem> JURASSIC_WORLD_ERA_POLISHED_CONCRETE = ModRegistry.ITEM_TYPES.register("jurassic_world_era_polished_concrete", () -> new BlockItem(BlockInit.JURASSIC_WORLD_ERA_POLISHED_CONCRETE.get(), new Item.Properties().group(CreativeTab.ANCIENT_TAB))); 
	public static final RegistryObject<BlockItem> JURASSIC_WORLD_ERA_POLISHED_CONCRETE_SLAB = ModRegistry.ITEM_TYPES.register("jurassic_world_era_polished_concrete_slab", () -> new BlockItem(BlockInit.JURASSIC_WORLD_ERA_POLISHED_CONCRETE_SLAB.get(), new Item.Properties().group(CreativeTab.ANCIENT_TAB))); 
	public static final RegistryObject<BlockItem> JURASSIC_WORLD_ERA_POLISHED_CONCRETE_STAIRS = ModRegistry.ITEM_TYPES.register("jurassic_world_era_polished_concrete_stairs", () -> new BlockItem(BlockInit.JURASSIC_WORLD_ERA_POLISHED_CONCRETE_STAIRS.get(), new Item.Properties().group(CreativeTab.ANCIENT_TAB))); 
	public static final RegistryObject<BlockItem> JURASSIC_WORLD_ERA_POLISHED_CONCRETE_WALL = ModRegistry.ITEM_TYPES.register("jurassic_world_era_polished_concrete_wall", () -> new BlockItem(BlockInit.JURASSIC_WORLD_ERA_POLISHED_CONCRETE_WALL.get(), new Item.Properties().group(CreativeTab.ANCIENT_TAB))); 
	public static final RegistryObject<BlockItem> JURASSIC_WORLD_ERA_POLISHED_CONCRETE_BUTTON = ModRegistry.ITEM_TYPES.register("jurassic_world_era_polished_concrete_button", () -> new BlockItem(BlockInit.JURASSIC_WORLD_ERA_POLISHED_CONCRETE_BUTTON.get(), new Item.Properties().group(CreativeTab.ANCIENT_TAB))); 
	public static final RegistryObject<BlockItem> JURASSIC_WORLD_ERA_POLISHED_CONCRETE_PRESSURE_PLATE = ModRegistry.ITEM_TYPES.register("jurassic_world_era_polished_concrete_pressure_plate", () -> new BlockItem(BlockInit.JURASSIC_WORLD_ERA_POLISHED_CONCRETE_PRESSURE_PLATE.get(), new Item.Properties().group(CreativeTab.ANCIENT_TAB))); 
	...
	public static final RegistryObject<BlockItem> JURASSIC_WORLD_ERA_INNOVATION_CENTRE_DOOR = ModRegistry.ITEM_TYPES.register("jurassic_world_era_innovation_centre_door", () -> new BlockItem(BlockInit.JURASSIC_WORLD_ERA_INNOVATION_CENTRE_DOOR.get(), new Item.Properties().group(CreativeTab.ANCIENT_TAB)));
	public static final RegistryObject<BlockItem> JURASSIC_WORLD_ERA_GLASS_DOOR = ModRegistry.ITEM_TYPES.register("jurassic_world_era_glass_door", () -> new BlockItem(BlockInit.JURASSIC_WORLD_ERA_GLASS_DOOR.get(), new Item.Properties().group(CreativeTab.ANCIENT_TAB)));
	public static final RegistryObject<BlockItem> JURASSIC_WORLD_ERA_BACK_DOOR = ModRegistry.ITEM_TYPES.register("jurassic_world_era_back_door", () -> new BlockItem(BlockInit.JURASSIC_WORLD_ERA_BACK_DOOR.get(), new Item.Properties().group(CreativeTab.ANCIENT_TAB)));
